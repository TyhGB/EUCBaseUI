...
@protocol OKAPhotoControllerDelegate <OKAPhotosProtocol>

// 查看图片时返回一个 OKABrowserController 控制器, 或者其子类的对象
- (OKABrowserController *)browserControllerAppearanceForPhotoController:(OKAPhotoController *)photoController;

@end

@interface OKAPhotoController : UIViewController

// 图片集
@property (nonatomic, strong) PHFetchResult *pPhotoFetchResult;

/** 已经选中的图片(OKAPhotoMode) */
...
/** 代理 */
@property (nonatomic, weak) id<OKAPhotoControllerDelegate> delegate;
