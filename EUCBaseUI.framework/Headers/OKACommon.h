...
// 回归主线程
#define OKA_dispatch_main_async_safe(block)\
...
//设备判断
#define IS_IPAD [OKACommon isIPad]
#define IS_IPAD_PRO [OKACommon isIPadPro]
#define IS_IPOD [OKACommon isIPod]
#define IS_IPHONE [OKACommon isIPhone]
#define IS_SIMULATOR [OKACommon isSimulator]

#define OKA_Scale [OKACommon oka_scale]
#define OKA_LayoutScale [OKACommon oka_layoutScale]


//打印字符串
#define OKAStr(...) [NSString stringWithFormat:__VA_ARGS__]
...
#define strongify_self __typeof__(weakSelf) strongSelf = weakSelf
#endif
...
// 过期标注
#define OKA_DEPRECATED(instead) NS_DEPRECATED(2_0, 2_0, 2_0, 2_0, instead)

// 无效标注
// init 方法
#define OKA_UNAVAILABLE_INIT(instead) __attribute__((unavailable(instead))) NS_DESIGNATED_INITIALIZER
// 普通方法
#define OKA_UNAVAILABLE(instead)      __attribute__((unavailable(instead)))
