...
typedef NS_ENUM(NSUInteger, OKAClipImageAdjustFrameViewType) {
    
    OKAClipImageAdjustFrameViewTypeFreedomRectangle,       //自动调节选框
    OKAClipImageAdjustFrameViewTypeOneToOneRatioRectangle, //1:1比例的选框
    OKAClipImageAdjustFrameViewTypeCustomRatioRectangle,   //自定义比例选框，直接设置aspectRatio即可
};

IB_DESIGNABLE
@interface OKAClipImageAdjustFrameView : UIView
...
/** 裁剪框类型 */
@property (nonatomic, assign) OKAClipImageAdjustFrameViewType type;
