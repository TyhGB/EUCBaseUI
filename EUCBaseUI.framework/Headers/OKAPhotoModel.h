...
typedef NS_ENUM(NSUInteger, OKAPhotoModelType) {
    OKAPhotoModelTypeImage,
    OKAPhotoModelTypeVideo,
};

@interface OKAPhotoModel : NSObject
...
@property (nonatomic, assign) OKAPhotoModelType type;
...
@property (nonatomic, assign) BOOL OKASelected;
